...
set_protected_mode:
    ...
    jmp CODE_SEG:init_protected_mode    ; Make a far jump to clear CPU pipelining, also update cs (code segment) register to point to the right index in GDT table
